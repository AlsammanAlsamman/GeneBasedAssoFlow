...
./submit.sh --snakefile rules/plot_snp_gene_comparison.smk /s/nath-lab/alsamman/___Analysis___/Hispanic_2025/MAGMA_PipiLIne/results/example_analysis/magma/snp_gene/example_analysis_plots.done
